...
let DashboardController = class DashboardController {
    ...
    getLiveRoutes(user, query) {
        return this.dashboardService.getLiveRoutes(user, query);
    }
    getDeliveriesStatus(user, query) {
...
__decorate([
    (0, common_1.Get)('routes/live'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, dashboard_query_dto_1.DashboardQueryDto]),
    __metadata("design:returntype", void 0)
], DashboardController.prototype, "getLiveRoutes", null);
__decorate([
    (0, common_1.Get)('deliveries/status'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, dashboard_query_dto_1.DashboardQueryDto]),
    __metadata("design:returntype", void 0)
], DashboardController.prototype, "getDeliveriesStatus", null);
